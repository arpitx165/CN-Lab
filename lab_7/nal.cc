...
void Nal::initialize()
{
    ...
    dest=par("dest");
    inf=200;
    tab.insert(make_pair(0,make_pair('A',make_pair(0,'-'))));
    tab.insert(make_pair(1,make_pair('B',make_pair(5,'-'))));
    tab.insert(make_pair(2,make_pair('C',make_pair(2,'-'))));
    tab.insert(make_pair(3,make_pair('D',make_pair(3,'-'))));
    tab.insert(make_pair(4,make_pair('E',make_pair(inf,'n'))));
    gtab.insert(make_pair(0,make_pair('A',gate("upout"))));
    gtab.insert(make_pair(1,make_pair('B',gate("down1out"))));
    gtab.insert(make_pair(2,make_pair('C',gate("down2out"))));
...
void Nal::handleMessage(cMessage *msg)
{
    // TODO - Generated method body
