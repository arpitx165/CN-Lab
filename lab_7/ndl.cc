...
void Ndl::initialize()
{
    ...
    src=par("src");
    dest=par("dest");
    tab.insert(make_pair(0,make_pair('A',make_pair(3,'-'))));
    tab.insert(make_pair(1,make_pair('B',make_pair(inf,'n'))));
    tab.insert(make_pair(2,make_pair('C',make_pair(inf,'A'))));
    tab.insert(make_pair(3,make_pair('D',make_pair(0,'-'))));
