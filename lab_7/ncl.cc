...
void Ncl::initialize()
{
    // TODO - Generated method body
       ...
       src=par("src");
       dest=par("dest");
       tab.insert(make_pair(0,make_pair('A',make_pair(2,'-'))));
       tab.insert(make_pair(1,make_pair('B',make_pair(4,'-'))));
       tab.insert(make_pair(2,make_pair('C',make_pair(0,'-'))));
       tab.insert(make_pair(3,make_pair('D',make_pair(inf,'n'))));
       tab.insert(make_pair(4,make_pair('E',make_pair(4,'-'))));
       gtab.insert(make_pair(0,make_pair('A',gate("downout"))));
       gtab.insert(make_pair(1,make_pair('B',gate("down1out"))));
       gtab.insert(make_pair(2,make_pair('C',gate("upout"))));
...
void Ncl::handleMessage(cMessage *msg)
{
    // TODO - Generated method body
